            ...
            <div class="sidebar-wrapper active">
                ...
                <div class="sidebar-menu d-flex flex-column justify-content-between" style="height: 85vh">
                    <ul class="menu">
                        ...
                        <li
                            class="sidebar-item has-sub {{ request()->is('user/peminjaman*', 'user/pengembalian*') ? 'active' : '' }}">
                        ...
                        <li
                            class="sidebar-item has-sub {{ request()->is('user/pesan-masuk*', 'user/pesan-terkirim*') ? 'active' : '' }}">
                            <a href="#" class="sidebar-link">
                            ...
                            <ul class="navbar-nav ms-auto mb-lg-0">
                                <li class="nav-item dropdown me-1">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton">
                                        ...
                                        <li><a class="dropdown-item" href="#">Pesan Keluar</a></li>
                                    </ul>
                                </li>
